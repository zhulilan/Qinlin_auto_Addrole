...
class TestAddrole():
    ...
    def test_role(self):
        ...
        sleep(3)
        # for i in checkboxs:
        #     # checkboxs= self.driver.find_elements_by_class_name('el-checkbox__inner')
        #     # ActionChains(self.driver).move_to_element('el-checkbox__inner').perform()
        #     i.click()
            # sleep(3)
        ...
        #     checkbox.click()
        #     sleep(2)
        # checkboxs = self.driver.find_elements_by_class_name('el-checkbox__input')
        # if checkboxs:
        ...
        for i in range(1,335):
            ar=str(i)
            self.driver.find_element_by_css_selector(".el-table__row:nth-child("+ar+") .codeclick:nth-child(1)").click()
